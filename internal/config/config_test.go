...
func TestDefault(t *testing.T) {
	...
	if d.OfflineSyncStrategy != "" {
		t.Errorf("expected offline_sync_strategy empty default, got %q", d.OfflineSyncStrategy)
	}
...
func TestWriteDefaultAndLoad(t *testing.T) {
	...
	if cfg.OfflineSyncStrategy != "" {
		t.Errorf("expected empty offline_sync_strategy, got %q", cfg.OfflineSyncStrategy)
	}
